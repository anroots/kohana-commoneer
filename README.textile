h1. Kohana Module Template

Is a simple code structure that you can use as start point to create your own Kohana Module
...
The basic idea is to include the most commontly used element in a module:
